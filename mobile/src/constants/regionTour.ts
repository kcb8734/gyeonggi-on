...
export const REGION_FESTIVAL_FALLBACKS: Record<string, HomeFestival[]> = {
  GYEONGGI: [
    fest('semiwon-lotus', '양평 세미원 연꽃문화제', '경기도 양평군', 37.541, 127.310, '2026-08-01', '2026-08-31', '계절축제', 'GYEONGGI', '양평 두물머리에 자리한 세미원에서 연꽃이 만개하는 한여름, 연꽃단지 산책과 수생식물 전시, 문화공연이 이어지는 경기도 대표 연꽃 축제입니다.', 'https://www.semiwon.or.kr'),
    fest('gg-1', '수원화성문화제', '경기도 수원시', 37.287, 127.013, '2026-08-19', '2026-09-21', '문화/예술', 'GYEONGGI', '세계유산 수원화성을 무대로 펼쳐지는 야간 퍼레이드와 전통 공연, 행궁 야행 프로그램이 이어집니다.', 'https://www.swcf.or.kr'),
    fest('gg-2', '용인 한국민속촌 축제', '경기도 용인시', 37.259, 127.117, '2026-08-21', '2026-09-11', '가족', 'GYEONGGI', '전통 가옥과 장터 체험, 가족 공연이 하루 종일 이어지는 용인 대표 가족 축제입니다.', 'https://www.koreanfolk.co.kr'),
    fest('gg-3', '가평 자라섬 재즈페스티벌', '경기도 가평군', 37.823, 127.513, '2026-08-22', '2026-09-05', '계절축제', 'GYEONGGI', '북한강 위 자라섬에서 열리는 국내 대표 재즈 페스티벌. 선셋 무대와 푸드존이 함께합니다.', 'https://www.jarasumjazz.com'),
    ...
    fest('gg-7', '이천쌀문화축제', '경기도 이천시', 37.272, 127.443, '2026-10-22', '2026-10-26', '가족', 'GYEONGGI', '임금님표 이천쌀과 가마솥 밥 체험이 이어지는 수확 축제입니다.', 'https://www.ricefestival.or.kr'),
    fest('gg-8', '안산 국제거리극축제', '경기도 안산시', 37.321, 126.831, '2026-05-15', '2026-05-18', '공연', 'GYEONGGI', '중앙역 일대에서 펼쳐지는 세계 거리극·서커스 축제입니다.', 'https://www.ansanfest.com'),
  ],
  GANGWON: [
